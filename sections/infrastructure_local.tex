...
All Python files containing application logic are located in the directory \highlight{smart\_heating\_local}.
...
The provided methods include downloading the latest heating schedule and the thermostat configuration linked to this local communication gateway and storing the data in the local storage using the \highlight{Config} class.

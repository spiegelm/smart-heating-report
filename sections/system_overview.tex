...
\todo[inline]{Local infrastructure is required for each residence; server used globally; multiple apps per residence possible}
...
On the other hand, there is the mobile application also acting as a client.
It provides an user interface to initially configure the system and maintain the heating schedule.
...
\todo[inline]{The relationship between the entities could also be represented in a diagram. Think of visualising the use cases. These terms should match the ones in the use-case section.}

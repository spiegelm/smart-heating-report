...
Whereas the server is the central entity to collect and store the accumulated sensor data and organizational data. Both parts are explained in Chapters \ref{sec:infrastructure}~\nameref{sec:infrastructure} and \ref{sec:mobile_app}~\nameref{sec:mobile_app}.

The mobile application part \dots\todo[inline]{SAMUEL: Mobile App text}

...
On the local communication gateway there are data sources: the log files written by two scripts and second, the local database used to cache the temperature readings and other meta information.
...
\todo[inline]{Analysis of the local database}
